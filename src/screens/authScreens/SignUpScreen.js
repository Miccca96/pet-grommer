...
export default function SignUpScreen({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <Header title="Moj nalog" type="arrow-left" navigation={navigation} />

      <ScrollView keyboardShouldPersistTaps="always">
        <View style={styles.view1}>
          <Text style={styles.text1}>Kreiraj svoj nalog</Text>
        </View>
        <Formik
          ...
          {props => (
            <View style={styles.view2}>
              <View>
                <Text style={styles.text2}>Novi ste na XXX ?</Text>
              </View>
              ...
              <View style={styles.view15}>
                <Text style={styles.text3}>
                  Kreiranjem ili prijavljivanjem na nalog{' '}
                </Text>
                <View style={styles.view16}>
                  <Text style={styles.text3}>slažete se sa našim </Text>
                  <Text style={styles.text4}> Odredbama & uslovima</Text>
                  <Text style={styles.text3}> i </Text>
                </View>
                <Text style={styles.text4}> Izjavom o privatnosti</Text>
              </View>
        ...
        <View style={styles.view19}>
          <View style={styles.view20}>
            <Text style={styles.text4}>Vec imate nalog?</Text>
          </View>
